...
('Bhupesh', 'bhupesh@gmail.com', 1, 'CAULIFLOWER', ' Tips for Growing Cauliflower. Well drained medium loam and or sandy loam soils are suitable.', 520),
('Shyaam', 'shyaam@gmail.com', 2, 'COTTON', 'Cotton is a soft, fluffy staple fiber that grows in a boll,around the seeds of the cotton ', 563),
('Raam', 'ramrao@gmail.com', 3, 'Silk', 'silk is best business developed from coocon for saries preparation and so on', 582);
